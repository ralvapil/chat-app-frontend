...
import { messageReceived, newConvosPushed } from '../../features/message/messageSlice'
...
function SocketProvider( {children} ) {
  ...
  useEffect(() => {
    if(user && isAuthorized) {
      ...
      const socketInstance = new Socket(dispatch, messageReceived, newConvosPushed, user);
